...
void main()
{
	...
	float height =  texture(displacement_texture, pass_texcoords).r;     
    vec2 texCoords = pass_texcoords - viewDir.xz  * (height * u_height_scale * 0.3); 
	...
	//geometry_diffuse = vec4(vec3(height), 1.0);
